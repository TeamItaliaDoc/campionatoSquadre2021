...
function caricaMatch(index, url)
{
    ...
    console.log('caricaMatch. Dati di ' + this.url);
        ...
        if (data.status != 'registration') 
        {
            ...
            //Penalità assegnate
            teams[team1].penalitàTotali += matchs[index].penalità1;
            teams[team2].penalitàTotali += matchs[index].penalità2;
            //Se terminata
...
function calcolaClassifica()
{
    ...
    for (var i in classificaTeams)         
    {
        ...
        stRiga = '<tr class="classifica-risultati">' +
            ...
            '<td class="classifica-risultati">' + teams[gruppo].penalitàTotali+ '</td>' +
